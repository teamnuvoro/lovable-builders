...
export function SetupBanner() {
  const isConfigured = VAPI_CONFIG.publicKey !== "YOUR_VAPI_PUBLIC_KEY_HERE";
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            ...
            <ol className="text-sm space-y-1 mb-2 ml-4 list-decimal">
              ...
              <li>Add it to <code className="bg-black/20 px-1 rounded">/config/vapi-config.ts</code> line 6</li>
              <li>Restart: <code className="bg-black/20 px-1 rounded">npm run dev</code></li>
            </ol>
            <p className="text-xs">
              📚 Detailed guide: Open <code className="bg-black/20 px-1 rounded">START_HERE.md</code> or <code className="bg-black/20 px-1 rounded">COPY_PASTE_THIS.md</code>
            </p>
          </div>
        </div>
      </div>
