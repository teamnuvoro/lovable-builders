...
export const CallingConfig = {
  // Choose your provider: 'daily' | 'agora' | 'twilio' | '100ms' | 'demo'
  provider: 'demo',
  
  // Daily.co Configuration
  daily: {
    apiKey: process.env.NEXT_PUBLIC_DAILY_API_KEY || 'YOUR_DAILY_API_KEY',
  ...
  twilio: {
    ...
    apiKeySid: process.env.TWILIO_API_KEY_SID || 'YOUR_TWILIO_API_KEY_SID',
    apiKeySecret: process.env.TWILIO_API_KEY_SECRET || 'YOUR_TWILIO_API_SECRET'
  },
  
  // 100ms Configuration
  hms: {
    appId: process.env.NEXT_PUBLIC_HMS_APP_ID || 'YOUR_100MS_APP_ID',
    appSecret: process.env.HMS_APP_SECRET || 'YOUR_100MS_APP_SECRET'
  },
