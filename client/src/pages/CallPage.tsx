  ...
  const handleStartCall = async () => {
    ...
    try {
      ...
      try {
        ...
        // We must start Vapi IMMEDIATELY on user click. 
        // Waiting for the backend mutation causes the browser to block audio.
...
Always be warm, supportive, and make the user feel heard and valued.`
        ...
        // Start backend tracking in background (fire and forget / update ref later)
