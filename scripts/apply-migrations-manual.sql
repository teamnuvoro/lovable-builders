-- =====================================================
-- VERSION 2 MIGRATIONS - MANUAL APPLICATION
-- 
...
-- Create trigger: Auto-update updated_at on whatsapp_reminders
...
SELECT '✅ WhatsApp reminders migration completed!' as status;
